                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Foto apresentação do iFesta.net</h1>
                                    <h2 class="animation animated-item-2">Com imagem informando que em breve teremos os aplicativos para Android e iOS</h2>
                ...
                <div class="item" style="background-image: url(images/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Foto com o tutorial simples do iFesta</h1>
                                    <h2 class="animation animated-item-2">Explicando o funcionamento do iFesta</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Saiba Mais</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Foto com logo dos novos Fornecedores</h1>
                                    <h2 class="animation animated-item-2">Informando quais empresas começaram a trabalhar no iFesta recentemente</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Saiba Mais</a>
                                </div>
                            </div>
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                ...
                                <a class="preview" href="images/portfolio/full/item6.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>                            </div> 
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                ...
                                <a class="preview" href="images/portfolio/full/item8.png" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>                            </div> 
                        </div>
                    </div>
                </div>   
            </div><!--/.row-->
