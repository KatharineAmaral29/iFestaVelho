...
<body>
    ...
    <section id="error" class="container text-center">
        ...
        <p>Não foi possível acessar a página ou ocorreu um erro.</p>
        <a class="btn btn-primary" href="index.jsp">VOLTE PARA A PÁGINA INICIAL</a>
    </section><!--/#error-->
